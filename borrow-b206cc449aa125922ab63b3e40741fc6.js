...
(function() {
  ...
  window.App.ReservationsChangeController = (function(superClass) {
    ...
    ReservationsChangeController.prototype.done = function(data) {
      var contract, i, len, ref;
      ref = App.Contract.currents;
      for (i = 0, len = ref.length; i < len; i++) {
        contract = ref[i];
  ...
  window.App.ReservationsCreateController = (function(superClass) {
    ...
    ReservationsCreateController.prototype.setupDates = function() {
      if (sessionStorage.startDate != null) {
        this.startDateEl.val(sessionStorage.startDate);
      } else {
        this.startDateEl.val(moment().format("YYYY-MM-DD"));
      }
      if (sessionStorage.endDate != null) {
        return this.endDateEl.val(sessionStorage.endDate);
      } else {
      ...
      for (time = i = 1, ref = quantity; 1 <= ref ? i <= ref : i >= ref; time = 1 <= ref ? ++i : --i) {
        results.push(this.createReservation().done((function(_this) {
          return function(datum) {
            ...
            if (App.Contract.exists(reservation.contract_id) != null) {
              return finish();
            } else {
              return App.Contract.ajaxFetch({
                ...
                if (!_.find(App.Contract.currents, function(c) {
                  return c.id === contract.id;
                })) {
                  App.Contract.currents.push(contract);
                }
                return finish();
              });
            }
...
(function() {
  ...
  window.App.UnsubmittedContractsBasketController = (function(superClass) {
    extend(UnsubmittedContractsBasketController, superClass);

    UnsubmittedContractsBasketController.prototype.elements = {
      "#current-order-lines": "reservationsContainer",
      "#order-overview-button": "orderOverviewButton"
    };

    function UnsubmittedContractsBasketController() {
      this.render = bind(this.render, this);
      this.delegateEvents = bind(this.delegateEvents, this);
      UnsubmittedContractsBasketController.__super__.constructor.apply(this, arguments);
    ...
    UnsubmittedContractsBasketController.prototype.delegateEvents = function() {
      return App.Contract.on("refresh", this.render);
    };

    UnsubmittedContractsBasketController.prototype.render = function() {
      var all_reservations, data, model_id, ref, reservations;
      data = [];
      all_reservations = _.flatten(_.map(App.Contract.currents, function(c) {
    ...
    return UnsubmittedContractsBasketController;
...
(function() {
  ...
  window.App.UnsubmittedContractsShowController = (function(superClass) {
    extend(UnsubmittedContractsShowController, superClass);

    UnsubmittedContractsShowController.prototype.elements = {
      "#current-order-lines": "reservationsContainer",
      ".emboss.red": "conflictsWarning"
    };

    UnsubmittedContractsShowController.prototype.events = {
      "click [data-change-order-lines]": "changeReservations"
    };

    function UnsubmittedContractsShowController() {
      this.render = bind(this.render, this);
      this.changeReservations = bind(this.changeReservations, this);
      this.delegateEvents = bind(this.delegateEvents, this);
      UnsubmittedContractsShowController.__super__.constructor.apply(this, arguments);
      if (!App.Contract.timedOut) {
        this.timeoutCountdown = new App.TimeoutCountdownController({
          el: this.el.find("#timeout-countdown"),
    ...
    UnsubmittedContractsShowController.prototype.delegateEvents = function() {
      UnsubmittedContractsShowController.__super__.delegateEvents.apply(this, arguments);
      return App.Contract.bind("refresh", (function(_this) {
        return function(data) {
          return _this.render();
        };
      })(this));
    ...
    UnsubmittedContractsShowController.prototype.changeReservations = function(e) {
    ...
    UnsubmittedContractsShowController.prototype.render = function() {
      var reservations;
      reservations = _.flatten(_.map(App.Contract.currents, function(c) {
        return c.reservations().all();
      }));
    ...
    return UnsubmittedContractsShowController;
  ...
  window.App.ModelsIndexController = (function(superClass) {
    ...
    ModelsIndexController.prototype.periodChange = function() {
      ...
      if (this.period.getPeriod() != null) {
        sessionStorage.startDate = this.period.getPeriod().start_date;
        sessionStorage.endDate = this.period.getPeriod().end_date;
        this.loading();
    ...
    ModelsIndexController.prototype.resetAndFetchModels = function() {
      this.reset.validate();
      this.loading();
      this.models = [];
...
(function() {
  ...
  window.App.ModelsIndexTooltipController = (function(superClass) {
    ...
    ModelsIndexTooltipController.prototype.fetchProperties = function(model_id) {
      return App.Property.ajaxFetch({
        ...
        return function() {
          ...
          tooltip = _this.tooltips[model_id];
          if (tooltip != null) {
            model = App.Model.find(model_id);
    ...
    ModelsIndexTooltipController.prototype.stayOnLine = function(e) {
      ...
      if (App.Model.exists(model_id)) {
        if (this.tooltips[model_id] == null) {
          tooltip = this.createTooltip(target);
          tooltip.disable();
          this.currentTooltip = tooltip;
          this.tooltips[model_id] = tooltip;
          return this.fetchProperties(model_id);
        } else {
          return this.currentTooltip = this.tooltips[model_id];
        }
      }
    };
...
(function() {
  ...
  window.App.TimeoutCountdownController = (function(superClass) {
    ...
    function TimeoutCountdownController(options) {
      ...
      this.countdown = new App.TimeoutCountdown(App.Contract.TIMEOUT_MINUTES);
      this.validateStart();
      this.delegateEvents();
    }
    ...
    TimeoutCountdownController.prototype.delegateEvents = function() {
      ...
      return App.Contract.on("refresh", (function(_this) {
        return function() {
          _this.validateStart();
          return _this.refreshTime();
        };
