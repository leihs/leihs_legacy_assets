      ...
      return App.Order.ajaxFetch({
        ...
        return function(data, status, xhr) {
          ...
          return _this.fetchUsers(orders).done(function() {
            return _this.fetchReservationsForOrders(orders).done(function() {
...
(function() {
  ...
  window.App.ItemEditController = (function(superClass) {
    ...
    ItemEditController.prototype.save = function(arg) {
      ...
      skipSerialNumberValidation = (ref = (arg != null ? arg : {}).skipSerialNumberValidation) != null ? ref : false;
      if (this.flexibleFieldsController.validate()) {
        return $.ajax({
          url: this.url,
    ...
    ItemEditController.prototype.prepareRequestData = function(skipSerialNumberValidation) {
      var field, i, len, ref, serial;
      if (skipSerialNumberValidation == null) {
        skipSerialNumberValidation = false;
      }
    ...
    ItemEditController.prototype.errorHandler = function(e) {
      ...
      if (e.responseJSON.can_bypass_unique_serial_number_validation) {
        ...
        if (saveAnyway) {
          return this.submit(e, (function(_this) {
            return function() {
              return _this.save({
                skipSerialNumberValidation: true
              });
            };
          })(this));
        } else {
    ...
    ItemEditController.prototype.submit = function(event, saveAction, errorHandler) {
      if (saveAction == null) {
        saveAction = this.save;
      }
      if (errorHandler == null) {
      ...
      return ItemEditController.__super__.submit.call(this, event, saveAction, errorHandler);
    };
