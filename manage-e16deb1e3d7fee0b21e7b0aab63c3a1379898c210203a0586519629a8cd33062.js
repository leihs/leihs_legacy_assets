...
(function() {
  ...
  window.App.Reservation.prototype.showsAlternativePickupLocation = function() {
    return this.alternativePickupLocationsEnabled() && !!this.pickup_location_id && !!this.pickupLocationName();
  };

  window.App.Reservation.prototype.showsHandedToCourierForPickup = function() {
    return this.showsAlternativePickupLocation() && this.status === "approved";
  };

  window.App.Reservation.prototype.showsHandedToCourierForReturn = function() {
    return this.alternativePickupLocationsEnabled() && this.status === "signed" && !this.option_id;
  };
