...
(function() {
  ...
  window.App.Inventory.findByInventoryCode = (function(_this) {
    return function(inventory_code, callback) {
      var inv_code_enc, xhr;
      inv_code_enc = encodeURIComponent(inventory_code).replace(/\./g, '%252E');
      xhr = new XMLHttpRequest();
      xhr.open('GET', "/manage/" + App.InventoryPool.current.id + "/inventory/" + inv_code_enc + ".json", true);
...
(function() {
  ...
  window.App.CategoriesIndexController = (function(superClass) {
    ...
    CategoriesIndexController.prototype.events = {
    ...
    function CategoriesIndexController() {
      ...
      this.openAll = bind(this.openAll, this);
      ...
      this.expander = new App.CategoriesIndexExpandController({
    ...
    CategoriesIndexController.prototype.openAll = function() {
      return this.expander.openAll();
    };

    CategoriesIndexController.prototype.closeAll = function() {
      return this.expander.closeAll();
    };
...
(function() {
  ...
  window.App.CategoriesIndexExpandController = (function(superClass) {
    ...
    CategoriesIndexExpandController.prototype.openAll = function(e, ctx) {
      var openFn;
      if (ctx == null) {
        ctx = this.el;
      }
      openFn = this.open;
      return ctx.find("[data-type='expander']").each(function() {
        return openFn($(this), true);
      });
    };

    CategoriesIndexExpandController.prototype.closeAll = function(e) {
      var closeFn;
      closeFn = this.close;
      return this.el.find("[data-type='expander']").each(function() {
        var target;
        target = $(this);
        if (target.data("_expanded") === false) {
          return;
        }
        return closeFn(target);
      });
    };
    ...
    CategoriesIndexExpandController.prototype.open = function(target, recurseChildren) {
      ...
      if (recurseChildren) {
        return this.openAll(null, childrenContainer);
      }
    };
...
(function() {
  ...
  window.App.ReservationsAddController = (function(superClass) {
    ...
    ReservationsAddController.prototype.submit = function(e) {
      ...
      if (inventoryCode.length) {
        App.Inventory.findByInventoryCode(inventoryCode, (function(_this) {
          return function(data) {
