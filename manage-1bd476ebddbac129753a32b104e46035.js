...
(function() {
  ...
  window.App.ManageBookingCalendar = (function(superClass) {
    ...
    ManageBookingCalendar.prototype.getGroupIds = function() {
      return this.partitionSelector_el.find("option:selected").data("value");
    };
...
(function() {
  ...
  window.App.Contract.prototype.approve = function(comment) {
    return $.post("/manage/" + App.InventoryPool.current.id + "/contracts/" + this.id + "/approve", {
      comment: comment
    });
  };

  window.App.Contract.prototype.approve_anyway = function(comment) {
    return $.post("/manage/" + App.InventoryPool.current.id + "/contracts/" + this.id + "/approve", {
      force: true,
      comment: comment
    });
  ...
  window.App.Contract.prototype.reject = function(comment) {
    return $.post("/manage/" + App.InventoryPool.current.id + "/contracts/" + this.id + "/reject", {
      comment: comment
    });
  };

  window.App.Contract.prototype.swapUser = function(user_id, delegated_user_id) {
    return $.post("/manage/" + App.InventoryPool.current.id + "/contracts/" + this.id + "/swap_user", {
      user_id: user_id,
      delegated_user_id: delegated_user_id
    });
  };

  window.App.Contract.prototype.sign = function(data) {
    return $.post(App.InventoryPool.url + "/" + App.InventoryPool.current.id + "/contracts/" + this.id + "/sign", data);
  };

  window.App.Contract.prototype.editPath = function() {
    return (App.Contract.url()) + "/" + this.id + "/edit";
  };

  window.App.Contract.prototype.handOverPath = function() {
    return (App.Contract.url()) + "/" + this.id + "/hand_over";
  };
...
(function() {
  ...
  window.App.CurrentItemLocation = (function(superClass) {
    extend(CurrentItemLocation, superClass);

    function CurrentItemLocation() {
      return CurrentItemLocation.__super__.constructor.apply(this, arguments);
    }

    CurrentItemLocation.configure("CurrentItemLocation", "id", "location");

    CurrentItemLocation.belongsTo("item", "App.Item", "id");

    CurrentItemLocation.extend(Spine.Model.Ajax);

    CurrentItemLocation.url = function() {
      return "/manage/" + App.InventoryPool.current.id + "/items/current_locations";
    };
...
(function() {
  ...
  window.App.Field = (function(superClass) {
    ...
    Field.configure("Field", "id", "attribute", "default", "display_attr", "display_attr_ext", "forPackage", "extended_key", "extensible", "form_name", "group", "label", "permissions", "required", "search_attr", "search_path", "type", "value_attr", "value_label", "value_label_ext", "values", "visibility_dependency_field_id", "visibility_dependency_value");
    ...
    Field.prototype.getItemValueLabel = function(value_label, item) {
      var reduceHelper, result, value_label_ext;
      if (item != null) {
        ...
        if (value_label_ext = reduceHelper(this.value_label_ext)) {
          result = [result, value_label_ext].join(" ");
        }
        return result;
      }
    };
...
(function() {
  window.App.Location.url = (function(_this) {
    return function() {
...
(function() {
  window.App.Purpose.url = (function(_this) {
    return function() {
      return "/manage/" + App.InventoryPool.current.id + "/purposes";
    };
  })(this);
...
(function() {
  ...
  window.App.Reservation.createOne = function(data) {
    return $.post("/manage/" + App.InventoryPool.current.id + "/reservations", data).done(function(reservation) {
      ...
      return App.Contract.trigger("refresh");
    });
  };

  window.App.Reservation.createForTemplate = function(data) {
    return $.post("/manage/" + App.InventoryPool.current.id + "/reservations/for_template", data).done(function(reservations) {
  ...
  window.App.Reservation.destroyMultiple = function(ids) {
    ...
    return App.Reservation.trigger("destroy", ids);
  };
...
(function() {
  ...
  window.App.FormWithUploadController = (function(superClass) {
    ...
    FormWithUploadController.prototype.submit = function(event, saveAction) {
      if (saveAction == null) {
        saveAction = this.save;
      }
      this.showLoading();
      return saveAction().fail((function(_this) {
        return function(e) {
          _this.showError(e.responseText);
...
(function() {
  ...
  window.App.ContractsApproveController = (function(superClass) {
    extend(ContractsApproveController, superClass);

    function ContractsApproveController() {
      ...
      return ContractsApproveController.__super__.constructor.apply(this, arguments);
    }

    ContractsApproveController.prototype.events = {
      "click [data-order-approve]": "approve"
    };

    ContractsApproveController.prototype.approve = function(e) {
      var comment, done, fail, order, ref, ref1, ref2, trigger;
      trigger = $(e.currentTarget);
      App.Button.disable(trigger);
      order = (ref = this.order) != null ? ref : App.Contract.findOrBuild(trigger.closest("[data-id]").data());
      done = (ref1 = this.done) != null ? ref1 : (function(_this) {
        return function() {
          var line;
          line = trigger.closest(".line");
          if (line != null) {
            return line.html(App.Render("manage/views/contracts/line_approved", order, {
      ...
      fail = (ref2 = this.fail) != null ? ref2 : (function(_this) {
        return function(response) {
          ...
          callback = function() {
            var line;
            line = trigger.closest(".line");
            new App.ContractsApproveFailedController({
              order: order,
              line: line,
              trigger: trigger,
    ...
    ContractsApproveController.prototype.fetchData = function(record, callback) {
    ...
    ContractsApproveController.prototype.fetchModels = function(ids) {
      if (ids.length) {
        return App.Model.ajaxFetch({
          data: $.param({
            ids: ids
    ...
    ContractsApproveController.prototype.fetchOptions = function(ids) {
      if (ids.length) {
    ...
    return ContractsApproveController;
...
(function() {
  ...
  window.App.ContractsApproveFailedController = (function(superClass) {
    extend(ContractsApproveFailedController, superClass);

    ContractsApproveFailedController.prototype.elements = {
      "#comment": "commentEl"
    };

    ContractsApproveFailedController.prototype.events = {
      "click [data-approve-anyway]": "approveAnyway"
    };

    function ContractsApproveFailedController(options) {
      this.approveAnyway = bind(this.approveAnyway, this);
      var tmpl;
      this.trigger = $(options.trigger);
      this.order = options.order;
      this.order.error = options.error;
      tmpl = App.Render("manage/views/contracts/approval_failed_modal", this.order, {
      ...
      ContractsApproveFailedController.__super__.constructor.apply(this, arguments);
    }

    ContractsApproveFailedController.prototype.approveAnyway = function() {
      var comment;
      ...
      return this.order.approve_anyway(comment).done((function(_this) {
        return function() {
          ...
          if (_this.done) {
            ...
            return _this.line.html(App.Render("manage/views/contracts/line_approved", _this.order, {
              accessRight: App.AccessRight,
              currentUserRole: App.User.current.role
            }));
          }
    ...
    return ContractsApproveFailedController;
...
(function() {
  ...
  window.App.ContractsApproveWithCommentController = (function(superClass) {
    extend(ContractsApproveWithCommentController, superClass);

    ContractsApproveWithCommentController.prototype.elements = {
      "#comment": "comment"
    };

    function ContractsApproveWithCommentController(options) {
      this.approved = bind(this.approved, this);
      var tmpl;
      this.trigger = options.trigger;
      this.contract = options.contract;
      tmpl = App.Render("manage/views/contracts/approve_with_comment_modal", this.contract);
      this.modal = new App.Modal(tmpl);
      this.el = this.modal.el;
      ContractsApproveWithCommentController.__super__.constructor.apply(this, arguments);
      new App.ContractsApproveController({
        el: this.el,
        done: this.approved,
    ...
    ContractsApproveWithCommentController.prototype.approved = function() {
      return window.location = "/manage/" + App.InventoryPool.current.id + "/daily?flash[success]=" + (_jed('Order approved'));
    };

    return ContractsApproveWithCommentController;
...
(function() {
  ...
  window.App.ContractsEditController = (function(superClass) {
    extend(ContractsEditController, superClass);

    ContractsEditController.prototype.elements = {
      "#status": "status",
    ...
    ContractsEditController.prototype.events = {
    ...
    function ContractsEditController() {
      this.contractApproved = bind(this.contractApproved, this);
      this.approveContractWithComment = bind(this.approveContractWithComment, this);
      ...
      this.delegateEvents = bind(this.delegateEvents, this);
      ContractsEditController.__super__.constructor.apply(this, arguments);
    ...
    ContractsEditController.prototype.delegateEvents = function() {
      ContractsEditController.__super__.delegateEvents.apply(this, arguments);
      App.Purpose.on("update", this.renderPurpose);
      App.Reservation.on("change destroy", this.fetchAvailability);
      return App.Contract.on("refresh", this.fetchAvailability);
    };

    ContractsEditController.prototype.setupAddLine = function() {
    ...
    ContractsEditController.prototype.setupLineSelection = function() {
      return this.lineSelection = new App.LineSelectionController({
        el: this.el
      });
    };

    ContractsEditController.prototype.validateLineDeletion = function(e) {
      var ids;
      ...
      if (this.contract.reservations().all().length <= ids.length) {
        App.Flash({
          type: "error",
    ...
    ContractsEditController.prototype.fetchAvailability = function() {
      this.render(false);
      this.status.html(App.Render("manage/views/availabilities/loading"));
      return App.Availability.ajaxFetch({
        data: $.param({
          model_ids: _.uniq(_.map(this.contract.reservations().all(), function(l) {
            return l.model().id;
          })),
    ...
    ContractsEditController.prototype.render = function(renderAvailability) {
      this.reservationsContainer.html(App.Render("manage/views/reservations/grouped_lines", this.contract.groupedLinesByDateRange(true), {
    ...
    ContractsEditController.prototype.editPurpose = function() {
      return new App.ContractsEditPurposeController({
        purpose: this.purpose
      });
    };

    ContractsEditController.prototype.swapUser = function() {
    ...
    ContractsEditController.prototype.renderPurpose = function() {
      return this.purposeContainer.html(this.purpose.description);
    };

    ContractsEditController.prototype.approveContractWithComment = function() {
      return new App.ContractsApproveWithCommentController({
        trigger: this.approveButton,
        contract: this.contract
      });
    };

    ContractsEditController.prototype.contractApproved = function() {
      return window.location = "/manage/" + App.InventoryPool.current.id + "/daily?flash[success]=" + (_jed('Order approved'));
    };

    return ContractsEditController;
...
(function() {
  ...
  window.App.ContractsEditPurposeController = (function(superClass) {
    extend(ContractsEditPurposeController, superClass);

    ContractsEditPurposeController.prototype.elements = {
      "textarea": "textarea",
      "#errors": "errorsContainer"
    };

    ContractsEditPurposeController.prototype.events = {
      "submit form": "submit"
    };

    function ContractsEditPurposeController(data) {
      this.delegateEvents = bind(this.delegateEvents, this);
      this.modal = new App.Modal(App.Render("manage/views/contracts/edit/purpose_modal", data.purpose));
      this.el = this.modal.el;
      ContractsEditPurposeController.__super__.constructor.apply(this, arguments);
    }

    ContractsEditPurposeController.prototype.delegateEvents = function() {
      return ContractsEditPurposeController.__super__.delegateEvents.apply(this, arguments);
    };

    ContractsEditPurposeController.prototype.submit = function(e) {
      e.preventDefault();
      this.purpose.description = _.string.clean(this.textarea.val());
      ...
      if (this.purpose.save()) {
        ...
        return this.errorsContainer.find("strong").text(this.purpose.validate());
      }
    };

    return ContractsEditPurposeController;
...
(function() {
  ...
  window.App.ContractsIndexController = (function(superClass) {
    ...
    function ContractsIndexController() {
      this.render = bind(this.render, this);
      this.fetchPurposes = bind(this.fetchPurposes, this);
        ...
        return function() {
          return _this.fetchUsers(page).done(function() {
            return _this.fetchReservations(page, function() {
              return _this.fetchPurposes(page, function() {
    ...
    ContractsIndexController.prototype.fetchContracts = function(page) {
      ...
      if (App.User.current.role === "group_manager") {
        data = $.extend(data, {
    ...
    ContractsIndexController.prototype.fetchReservations = function(page, callback) {
      ...
      return _(ids).each_slice(300, (function(_this) {
    ...
    ContractsIndexController.prototype.fetchPurposes = function(page, callback) {
      var done, ids;
      ids = _.compact(_.filter(_.map(_.flatten(_.map(this.contracts[page], function(o) {
        return o.reservations().all();
      })), function(l) {
        return l.purpose_id;
      }), function(id) {
        return App.Purpose.exists(id) == null;
      }));
      if (!ids.length) {
        callback();
      }
...
(function() {
  ...
  window.App.ContractsRejectController = (function(superClass) {
    extend(ContractsRejectController, superClass);

    function ContractsRejectController() {
      this.fetchOptions = bind(this.fetchOptions, this);
      this.fetchModels = bind(this.fetchModels, this);
      this.fetchData = bind(this.fetchData, this);
      this.reject = bind(this.reject, this);
      this.setupModal = bind(this.setupModal, this);
      return ContractsRejectController.__super__.constructor.apply(this, arguments);
    }

    ContractsRejectController.prototype.events = {
      "click [data-order-reject]": "setupModal"
    };

    ContractsRejectController.prototype.setupModal = function(e) {
      var callback;
      this.trigger = $(e.currentTarget);
      this.order = App.Contract.findOrBuild(this.trigger.closest("[data-id]").data());
      callback = (function(_this) {
        return function() {
          _this.modal = new App.Modal(App.Render("manage/views/contracts/reject_modal", _this.order));
          if (_this.async) {
    ...
    ContractsRejectController.prototype.reject = function(e) {
      ...
      callback = (ref = this.callback) != null ? ref : (function(_this) {
        return function() {
          var button;
          button = $(_this.trigger).closest(".multibutton").length ? $(_this.trigger).closest(".multibutton").find(".button:first") : $(_this.trigger);
          button.html(App.Render("manage/views/contracts/rejected_button"));
          return App.Button.disable(button);
        };
      })(this);
      return callback.call(this);
    };

    ContractsRejectController.prototype.fetchData = function(record, callback) {
      var i, len, line, modelIds, optionIds, ref;
      modelIds = [];
      optionIds = [];
      ref = record.reservations().all();
    ...
    ContractsRejectController.prototype.fetchModels = function(ids) {
      if (ids.length) {
        return App.Model.ajaxFetch({
          data: $.param({
            ids: ids
    ...
    ContractsRejectController.prototype.fetchOptions = function(ids) {
      if (ids.length) {
        return App.Option.ajaxFetch({
          data: $.param({
            ids: ids
    ...
    return ContractsRejectController;
...
(function() {
  ...
  window.App.HandOverController = (function(superClass) {
    ...
    HandOverController.prototype.delegateEvents = function() {
      ...
      App.Reservation.on("change destroy", (function(_this) {
        return function(data) {
      ...
      App.Contract.on("refresh", this.fetchAvailability);
    ...
    HandOverController.prototype.initalFetch = function() {
      ...
      if (this.getLines().length) {
        if (this.notFetchedItemIds().length) {
          fi = $.Deferred(this.fetchItems);
        }
        if (this.notFetchedLicenseIds().length) {
          fl = $.Deferred(this.fetchLicenses);
        }
        if ((fi != null) || (fl != null)) {
          return $.when(fi, fl).done(this.fetchAvailability);
        } else {
...
(function() {
  ...
  window.App.HandOverDialogController = (function(superClass) {
    ...
    function HandOverDialogController(options) {
      ...
      this.handOver = bind(this.handOver, this);
      this.setupModal = bind(this.setupModal, this);
      this.validateAssignment = bind(this.validateAssignment, this);
      this.validateEndDate = bind(this.validateEndDate, this);
      this.validateStartDate = bind(this.validateStartDate, this);
      this.validateDialog = bind(this.validateDialog, this);
      ...
      this.purpose = (_.uniq(_.map(this.reservations, function(l) {
        return l.purpose().description;
      }))).join(", ");
      if (this.validateDialog()) {
        this.setupModal();
        if (this.user.isDelegation()) {
          App.User.ajaxFetch({
            data: $.param({
              delegation_id: this.user.id
            })
          }).done((function(_this) {
            return function(data) {
              var datum;
              return _this.searchSetContactPersonController = new App.SearchSetUserController({
                el: _this.el.find("#contact-person"),
                localSearch: true,
                ...
                selectCallback: function() {
                  return _this.contract.delegated_user_id = _this.searchSetContactPersonController.selectedUserId;
                }
              });
            };
          })(this));
        ...
        this.contract.delegated_user_id = null;
        this.autoFocus();
      } else {
        return false;
      }
    ...
    HandOverDialogController.prototype.autoFocus = function() {
      var ref;
      if ((ref = this.searchSetContactPersonController) != null ? ref.input.length : void 0) {
        return this.searchSetContactPersonController.input.focus();
      } else if (this.purposeTextArea.length) {
    ...
    HandOverDialogController.prototype.validateDialog = function() {
      return this.validateStartDate() && this.validateEndDate() && this.validateAssignment();
    };

    HandOverDialogController.prototype.validateStartDate = function() {
      if (_.any(this.reservations, function(l) {
    ...
    HandOverDialogController.prototype.validateEndDate = function() {
      if (_.any(this.reservations, function(l) {
    ...
    HandOverDialogController.prototype.validateAssignment = function() {
      if (_.any(this.reservations, function(l) {
    ...
    HandOverDialogController.prototype.setupModal = function() {
      ...
      tmpl = $(App.Render("manage/views/users/hand_over_dialog", data, {
        showAddPurpose: _.any(this.reservations, function(l) {
          return l.purpose_id == null;
        }),
        currentInventoryPool: App.InventoryPool.current
      }));
      tmpl.find("#add-purpose").on("click", (function(_this) {
        return function(e) {
          return $(e.currentTarget).remove() && tmpl.find("#purpose-input").removeClass("hidden");
        };
      })(this));
      this.modal = new App.Modal(tmpl);
    ...
    HandOverDialogController.prototype.handOver = function() {
      ...
      if (this.validatePurpose() && this.validateDelegatedUser()) {
        return this.contract.sign({
          line_ids: _.map(this.reservations, function(l) {
            return l.id;
          }),
          purpose: this.purposeTextArea.val(),
          note: this.noteTextArea.val(),
          delegated_user_id: (ref = this.contract.delegatedUser()) != null ? ref.id : void 0
        }).fail((function(_this) {
          return function(e) {
    ...
    HandOverDialogController.prototype.validateDelegatedUser = function() {
      if (this.contract.user().isDelegation() && !this.contract.delegatedUser()) {
        this.errorContainer.find("strong").html(_jed("Specification of the contact person is required"));
        this.errorContainer.removeClass("hidden");
        this.searchSetContactPersonController.input.focus();
        return false;
      } else {
        return true;
      }
      ...
      console.log('assignedOrCreated', {
        ...
        return function() {
          ...
          if (App.Reservation.exists(data.id)) {
            ...
            App.Contract.trigger("refresh", _this.contract);
            App.Flash({
              type: "success",
...
(function() {
  ...
  window.App.SearchSetUserController = (function(superClass) {
    ...
    SearchSetUserController.prototype.selectUser = function(user) {
      ...
      this.selectedUser.html(App.Render("manage/views/contracts/edit/swapped_user", user));
...
(function() {
  ...
  window.App.SwapUsersController = (function(superClass) {
    ...
    function SwapUsersController(data) {
      ...
      this.swapContract = bind(this.swapContract, this);
      this.delegateEvents = bind(this.delegateEvents, this);
      this.contract = data.reservations != null ? data.reservations[0].contract() : data.contract;
      this.modal = new App.Modal(App.Render("manage/views/contracts/edit/swap_user_modal", this.contract));
      this.el = this.modal.el;
      ...
      this.searchSetUserController = new App.SearchSetUserController({
        ...
        selectCallback: this.manageContactPerson ? (function(_this) {
          return function() {
    ...
    SwapUsersController.prototype.swapContract = function() {
      var ref, ref1, userId;
      userId = (ref = this.searchSetUserController.selectedUserId) != null ? ref : this.contract.user().id;
      return this.contract.swapUser(userId, (ref1 = this.searchSetContactPersonController) != null ? ref1.selectedUserId : void 0).done((function(_this) {
        return function(data) {
          var contract;
          contract = new App.Contract(data);
          return window.location = contract.editPath();
        };
    ...
    SwapUsersController.prototype.swapReservations = function() {
      return App.Reservation.swapUser(this.reservations, this.searchSetUserController.selectedUserId).done((function(_this) {
        ...
        return function() {
          _this.errorsContainer.removeClass("hidden");
          App.Button.enable(_this.submitButton);
          return _this.errorsContainer.find("strong").text(_jed("Invalid data"));
        };
      })(this));
    };

    SwapUsersController.prototype.renderContactPerson = function() {
      return this.form.append(App.Render("manage/views/contracts/edit/contact_person", this.contract));
    };
    ...
    SwapUsersController.prototype.setupContactPerson = function() {
      ...
      user_id = (ref = this.searchSetUserController.selectedUserId) != null ? ref : this.contract.user().id;
  ...
  window.App.TakeBackController = (function(superClass) {
    ...
    TakeBackController.prototype.getCheckLineFunction = function(inv_code) {
      ...
      return function(line) {
        return line.inventoryCode() === inv_code && (line.option() ? el.find(".line[data-id='" + line.id + "'] input[data-quantity-returned]").val() < line.quantity : true);
      };
    };
...
(function() {
  ...
  window.App.VisitsIndexController = (function(superClass) {
    ...
    VisitsIndexController.prototype.fetchPurposes = function(page, callback) {
      var done, ids;
      ids = _.compact(_.filter(_.map(_.flatten(_.map(this.visits[page], function(o) {
        return o.reservations().all();
      })), function(l) {
        return l.purpose_id;
      }), function(id) {
...
(function() {
  ...
  window.App.SearchOverviewController = (function(superClass) {
    ...
    function SearchOverviewController() {
      ...
      this.fetchCurrentItemLocation = bind(this.fetchCurrentItemLocation, this);
      this.fetchModels = bind(this.fetchModels, this);
    ...
    SearchOverviewController.prototype.removeLoading = _.after(5, function() {
      ...
      return App.Item.ajaxFetch({
        ...
        return function(data, status, xhr) {
          ...
          return _this.fetchModels(items).done(function() {
            return _this.fetchCurrentItemLocation(items).done(function() {
    ...
    SearchOverviewController.prototype.searchLicenses = function() {
      return App.License.ajaxFetch({
        ...
        return function(data, status, xhr) {
          ...
          return _this.fetchModels(licenses).done(function() {
            return _this.fetchCurrentItemLocation(licenses).done(function() {
    ...
    SearchOverviewController.prototype.fetchCurrentItemLocation = function(items) {
      var ids;
      ids = _.map(items, function(i) {
        return i.id;
      });
      if (!ids.length) {
        return {
      ...
      return App.CurrentItemLocation.ajaxFetch({
        data: $.param({
          ids: ids,
          all: true,
          paginate: false,
    ...
    SearchOverviewController.prototype.fetchReservations = function(records) {
      var ids;
      ...
      return App.Contract.ajaxFetch({
        ...
        return function(data, status, xhr) {
          ...
          return _this.fetchUsers(contracts).done(function() {
            return _this.fetchReservations(contracts).done(function() {
              return _this.fetchPurposes(contracts).done(function() {
                return _this.render(_this.orders, "manage/views/contracts/line", contracts, xhr);
              });
            });
          });
        };
    ...
    SearchOverviewController.prototype.fetchPurposes = function(contracts) {
      var ids;
      ids = _.compact(_.filter(_.map(_.flatten(_.map(contracts, function(o) {
        return o.reservations().all();
      })), function(l) {
        return l.purpose_id;
      }), function(id) {
...
(function() {
  ...
  window.App.SearchResultsItemsController = (function(superClass) {
    ...
    SearchResultsItemsController.prototype.fetchCurrentItemLocation = function(items) {
      var ids;
      ids = _.map(items, function(i) {
        return i.id;
      });
...
(function() {
  ...
  window.App.SearchResultsOrdersController = (function(superClass) {
    ...
    SearchResultsOrdersController.prototype.model = "Contract";

    SearchResultsOrdersController.prototype.templatePath = "manage/views/contracts/line";
        ...
        return function(data) {
          ...
          return _this.fetchUsers(orders).done(function() {
            return _this.fetchReservations(orders).done(function() {
              return _this.fetchPurposes(orders).done(function() {
                return callback();
              });
            });
          });
    ...
    SearchResultsOrdersController.prototype.fetchPurposes = function(orders) {
      var ids;
      ids = _.compact(_.filter(_.map(_.flatten(_.map(orders, function(o) {
        return o.reservations().all();
      })), function(l) {
        return l.purpose_id;
      }), function(id) {
...
(function() {
  ...
  window.App.InventoryExpandController = (function(superClass) {
    ...
    InventoryExpandController.prototype.fetchData = function(line, callback) {
      ...
      return this.fetchCurrentItemLocation(line, itemIds).done((function(_this) {
        return function() {
          return _this.fetchPackageItems(line, itemIds).done(function(data) {
    ...
    InventoryExpandController.prototype.fetchCurrentItemLocation = function(line, itemIds) {
      return App.CurrentItemLocation.ajaxFetch({
        data: $.param({
          ids: itemIds,
          all: true,
    ...
    InventoryExpandController.prototype.updateChildren = function(line) {
      ...
      return currentContainer.replaceWith(line.data("_children"));
    };
...
(function() {
  ...
  App.InventoryHelperController = (function(superClass) {
    ...
    function InventoryHelperController() {
      ...
      this.fetchItemLocations = bind(this.fetchItemLocations, this);
      this.fetchItems = bind(this.fetchItems, this);
    ...
    InventoryHelperController.prototype.getFields = function(request, response) {
      ...
      fields = _.filter(App.Field.all(), (function(_this) {
        return function(field) {
          return (field.getLabel().match(new RegExp(request.term, "i")) != null) && !App.Field.isPresent(field, _this.fieldSelection) && (field.visibility_dependency_field_id == null) && field.id !== 'attachments';
        };
      })(this));
    ...
    InventoryHelperController.prototype.removeField = function(e) {
      var child, field, j, len, ref, target;
      target = $(e.currentTarget).closest("[data-type='field']");
      field = App.Field.find(target.data("id"));
      ref = field.children();
      for (j = 0, len = ref.length; j < len; j++) {
        child = ref[j];
        this.fieldSelection.find("[name='" + (child.getFormName()) + "']").closest("[data-type='field']").remove();
      }
      target.remove();
        ...
        source: (function(_this) {
          return function(request, response) {
            return _this.fetchItems(request.term).done(function(data) {
              ...
              return _this.fetchItemLocations(items).done(function() {
    ...
    InventoryHelperController.prototype.fetchItemLocations = function(items) {
      var ids;
      ids = _.map(items, function(i) {
        return i.id;
      });
    ...
    InventoryHelperController.prototype.applyFields = function() {
      ...
      if (!inventoryCode.length) {
        ...
        data = this.fieldSelection.serializeArray();
    ...
    InventoryHelperController.prototype.setupAppliedItem = function(status) {
      ...
      if (this.currentItemData.owner_id === App.InventoryPool.current.id || this.currentItemData.inventory_pool_id === App.InventoryPool.current.id) {
        this.editButton.removeClass("hidden");
        this.saveButton.addClass("hidden");
        this.cancelButton.addClass("hidden");
      }
      this.highlightChangedFields(this.fieldSelection.find(".field"), status);
      return $(document).scrollTop(this.itemSection.offset().top);
    };

    InventoryHelperController.prototype.highlightChangedFields = function(fields, status) {
      var fieldEl, j, len, results;
      results = [];
    ...
    InventoryHelperController.prototype.setupItemEdit = function(writeable) {
      var replacement;
    ...
    InventoryHelperController.prototype.updateItem = function(item, data) {
      ...
      if (!data.length) {
        ...
        return item.updateWithFieldData(data).fail((function(_this) {
          return function(e) {
            return _this.setNotification(e.responseText, "error");
          };
        })(this));
      }
    };
    ...
    InventoryHelperController.prototype.saveItem = function() {
      ...
      if (this.flexibleFieldsController.validate()) {
        ...
        this.updateItem(item, this.flexibleFields.serializeArray()).done((function(_this) {
          return function() {
            return _this.fetchItemWithFlexibleFields(item).done(function(itemData) {
              _this.currentItemData = itemData;
...
(function() {
  ...
  window.App.ItemAttachmentsController = (function(superClass) {
    ...
    function ItemAttachmentsController() {
      ...
      ItemAttachmentsController.__super__.constructor.apply(this, arguments);
      this.type = "attachment";
      this.templatePath = "manage/views/items/fields/writeable/partials/attachment_inline_entry";
      new App.InlineEntryRemoveController({
        el: this.el
      });
    }
    ...
    return ItemAttachmentsController;
  ...
  window.App.ItemEditController = (function(superClass) {
    ...
    function ItemEditController() {
      ...
      this.flexibleFieldsController = new App.ItemFlexibleFieldsController({
        ...
        callback: (function(_this) {
          return function() {
            return _this.attachmentsController = new App.ItemAttachmentsController({
    ...
    ItemEditController.prototype.save = function() {
      if (this.flexibleFieldsController.validate()) {
        return $.ajax({
          url: this.url,
          data: this.itemForm.serializeArray(),
          type: this.method
        });
      } else {
    ...
    ItemEditController.prototype.done = function(data) {
      ...
      return this.attachmentsController.upload((function(_this) {
        return function() {
    ...
    ItemEditController.prototype.finish = function(redirectUrl) {
      ...
      if (this.attachmentsController.uploadErrors.length) {
        return this.setupErrorModal(this.item);
      } else {
        url = redirectUrl != null ? redirectUrl : App.Inventory.url();
        return window.location = url + "?flash[success]=" + (_jed('Item saved'));
      }
    };

    ItemEditController.prototype.submit = function(event, saveAction) {
      if (saveAction == null) {
        saveAction = this.save;
      }
      return ItemEditController.__super__.submit.call(this, event, saveAction);
    };
    ...
    ItemEditController.prototype.saveAndCopy = function() {
      if (this.flexibleFieldsController.validate()) {
        this.copyInput.prop("disabled", false);
        return $.ajax({
          url: this.url,
          data: this.itemForm.serializeArray(),
          type: this.method
...
(function() {
  ...
  window.App.ModelsEditController = (function(superClass) {
    ...
    ModelsEditController.prototype.finish = function() {
      if (this.imagesController.uploadErrors.length || this.attachmentsController.uploadErrors.length) {
        return this.setupErrorModal(this.model);
      } else {
        return window.location = App.Inventory.url() + ("?flash[success]=" + (_jed('Model saved')));
      }
    };
  ...
  window.App.ModelsPackageDialogController = (function(superClass) {
    ...
    ModelsPackageDialogController.prototype.save = function() {
      ...
      if (!this.children.length) {
        ...
        this.modal.destroy(true);
        data = _.map(this.itemForm.serializeArray(), function(datum) {
          return {
            name: datum.name.replace(/item/, ""),
            value: datum.value
          };
        });
        return this.done(data, this.children, this.entry);
      }
    };
  ...
  window.App.ReservationsAddController = (function(superClass) {
    ...
    ReservationsAddController.prototype.add = function(record, startDate, endDate, inventoryCode) {
      if (record instanceof App.Model) {
        return this.addModel(record, startDate, endDate, inventoryCode);
      } else if (record instanceof App.Option) {
        return this.addOption(record, startDate, endDate);
      } else if (record instanceof App.Template) {
        return this.addTemplate(record, startDate, endDate);
      }
    };
    ...
    ReservationsAddController.prototype.addModel = function(model, startDate, endDate, inventoryCode) {
      ...
      if (this.addModelForHandOver && inventoryCode) {
        ...
        return App.Reservation.createOne({
          ...
          contract_id: this.contract.id,
          purpose_id: (ref = this.purpose) != null ? ref.id : void 0,
          quantity: 1,
          model_id: model.id
        }).done((function(_this) {
          return function(line) {
    ...
    ReservationsAddController.prototype.addOption = function(option, startDate, endDate) {
      var line, quantity, ref;
      line = _.find(this.contract.reservations().all(), function(l) {
...
(function() {
  ...
  window.App.ReservationAssignItemController = (function(superClass) {
    ...
    ReservationAssignItemController.prototype.searchItems = function(e) {
      ...
      return (model.constructor === App.Model ? this.fetchItems(model) : model.constructor === App.Software ? this.fetchLicenses(model) : void 0).done((function(_this) {
        return function(data) {
          ...
          if (items.length) {
            location_ids = _.compact(_.uniq(_.map(items, function(i) {
              return i.location_id;
            })));
            return _this.fetchLocations(location_ids).done(function(data) {
              var building_ids, locations;
              if (data != null) {
                locations = (function() {
                  var j, len, results;
                  results = [];
                  for (j = 0, len = data.length; j < len; j++) {
                    datum = data[j];
                    results.push(App.Location.find(datum.id));
                  }
                  return results;
                })();
                building_ids = _.compact(_.uniq(_.map(locations, function(l) {
                  return l.building_id;
                })));
                return _this.fetchBuildings(building_ids).done(function() {
    ...
    ReservationAssignItemController.prototype.fetchLocations = _.partial(ReservationAssignItemController.prototype.fetchWithIds, App.Location);
  ...
  window.App.ReservationsChangeController = (function(superClass) {
    ...
    ReservationsChangeController.prototype.createReservation = function() {
      ...
      return App.Reservation.createOne({
        ...
        start_date: this.getStartDate().format("YYYY-MM-DD"),
        end_date: this.getEndDate().format("YYYY-MM-DD"),
        contract_id: (ref = this.contract) != null ? ref.id : void 0,
        purpose_id: _.first(this.reservations).purpose_id,
        quantity: 1
      }).fail((function(_this) {
        return function(e) {
          return _this.fail(e);
    ...
    ReservationsChangeController.prototype.storeOptionLine = function() {
      ...
      if (this.getQuantity() != null) {
        ...
        return this.done(line.contract());
      } else {
        return this.changeRange();
      }
    };
      ...
      if (data != null) {
        if (data.length) {
          target.html(App.Render("manage/views/models/explorative_add_line", data, {
            startDate: this.startDate,
            endDate: this.endDate,
            groupIds: this.contract.user().groupIds
          }));
          if (page === 1) {
            return this.pagination.renderPlaceholders();
          }
...
(function() {
  ...
  window.App.LinesCellTooltipController = (function(superClass) {
    ...
    LinesCellTooltipController.prototype.onEnter = function(e) {
      ...
      trigger = $(e.currentTarget);
      record = trigger.closest(".line[data-type='contract']").length ? App.Contract.findOrBuild(trigger.closest(".line[data-type='contract']").data()) : trigger.closest(".line[data-type='take_back']").length ? App.Visit.findOrBuild(trigger.closest(".line[data-type='take_back']").data()) : trigger.closest(".line[data-type='hand_over']").length ? App.Visit.findOrBuild(trigger.closest(".line[data-type='hand_over']").data()) : void 0;
      tooltip = new App.Tooltip({
